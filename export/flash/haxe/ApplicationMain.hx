...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/dude.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/fg.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/map.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/skull.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/temp_tiles.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/treasure.png");
		types.push (lime.Assets.AssetType.IMAGE);
