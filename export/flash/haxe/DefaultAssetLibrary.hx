...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/dude.png", __ASSET__assets_images_dude_png);
		type.set ("assets/images/dude.png", AssetType.IMAGE);
		className.set ("assets/images/fg.png", __ASSET__assets_images_fg_png);
		type.set ("assets/images/fg.png", AssetType.IMAGE);
		...
		className.set ("assets/images/skull.png", __ASSET__assets_images_skull_png);
		type.set ("assets/images/skull.png", AssetType.IMAGE);
		className.set ("assets/images/temp_tiles.png", __ASSET__assets_images_temp_tiles_png);
		type.set ("assets/images/temp_tiles.png", AssetType.IMAGE);
		className.set ("assets/images/treasure.png", __ASSET__assets_images_treasure_png);
		type.set ("assets/images/treasure.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/dude.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fg.png";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/skull.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/temp_tiles.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/treasure.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_dude_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_fg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_skull_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_temp_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_treasure_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/dude.png") #if display private #end class __ASSET__assets_images_dude_png extends lime.graphics.Image {}
@:image("assets/images/fg.png") #if display private #end class __ASSET__assets_images_fg_png extends lime.graphics.Image {}
...
@:image("assets/images/skull.png") #if display private #end class __ASSET__assets_images_skull_png extends lime.graphics.Image {}
@:image("assets/images/temp_tiles.png") #if display private #end class __ASSET__assets_images_temp_tiles_png extends lime.graphics.Image {}
@:image("assets/images/treasure.png") #if display private #end class __ASSET__assets_images_treasure_png extends lime.graphics.Image {}
